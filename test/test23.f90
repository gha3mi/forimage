program test23
    ...
    call ex23_1%set_pnm(encoding='binary', file_format='pbm', width=6, height=10, comment='test 1', pixels=px1)
    call ex23_1%flip_horizontal()
    call ex23_1%export_pnm('pnm_files/img1_binary_flip_horizontal')
    call ex23_1%print_info()
    ...
    call ex23_2%set_pnm(encoding='binary', file_format='pgm', width=60, height=60, max_color=255, comment='test 2', pixels=px2)
    call ex23_2%flip_horizontal()
    call ex23_2%export_pnm('pnm_files/img2_binary_flip_horizontal')
    call ex23_2%print_info()
    ...
    call ex23_3%set_pnm(encoding='binary', file_format='ppm', width=4, height=4, max_color=15, comment='test 2', pixels=px3)
    call ex23_3%flip_horizontal()
    call ex23_3%export_pnm('pnm_files/img3_binary_flip_horizontal')
    call ex23_3%print_info()
    call ex23_3%finalize()


    call ex23_3%set_pnm(encoding='binary', file_format='ppm', width=4, height=4, max_color=15, comment='test 2', pixels=px3)
    call ex23_3%flip_vertical()
    call ex23_3%export_pnm('pnm_files/img3_binary_flip_vertical')
    call ex23_3%print_info()
    call ex23_3%finalize()
